...
class _StatementOfAssetsState extends State<StatementOfAssets> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Statement of Assets'),  actions: [
        IconButton(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            HeaderWidget(title: '13.613,62 EUR', subTitle: '+3.247,63 (+24,17%)',),
            ...
            ListView.separated(
              ...
              itemBuilder: (context, index) {
                return ShareDataWidget(imagePath: 'green_graph.png', assetName: 'iShares Core MSCI Europe', assetNumber: 'IE00B1YZSC51',differenceInPercent: '12,31% of all assets',
                assetValue: '€1.675,67', assetCalculation: '61,0 x €27,47', differenceInNumber: '+€515,11 (+43,82%)',);
              }
            )
